...
class CONNECTION():
    ...
    jd_selector = 'div:nth-child(1) > div:nth-child(1)'
    ...
    def validate_element(self,parent_section_xpath,selector,defaule_val='-1'):
        try:
            ...
            element = parent_section_xpath.find_element(By.CSS_SELECTOR,selector).text      
            return element
        
        except NoSuchElementException as e:
        
            print(f'Element is not found {e}, default value -1 is given')
            return defaule_val
    ...
    def retrieve_info(self):
        ...
        if trial <5:
            ...
            if len(self.driver.find_element(By.XPATH,self.basicInfo_Xpath).text.split('\n'))==4:
                ...
                stor_xpathtxt['position_indo'] = self.driver.find_element(By.XPATH,self.basicInfo_Xpath).text
                stor_xpathtxt['if_easy_apply'] = self.driver.find_element(By.XPATH,self.ifEasyApply_Xpath).text
                # print(stor_xpathtxt['if_easy_apply'])
    ...
    async def click_next_turn(self):
        ...
        for nb_turn in range(math.floor(self.search_limit/30)): #one fold explores 30 more position
            ...
            print('successfully click newx job page')
...
if __name__ =='__main__':
    ...
    glassdoor_connect = CONNECTION(url=url_bi_analyst)
    asyncio.run(glassdoor_connect.main())
    # glassdoor_connect.main()
    print(glassdoor_connect.stor_data)
